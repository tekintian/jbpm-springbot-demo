...
import cn.tekin.jbpm.demo.service.Business1ReviewLogService;
...
public class UserTaskController {
    ...
    public ModelAndView groupTaskList() {
        ...
        String groupStr = "";
        if (role != null && role.size() > 0 && !StringUtils.isBlank(role.get(0).getName())) {
    ...
    public String completeTask(@RequestParam String id, @RequestParam Map<String, String> allRequestParams) {
        ...
        try {
            ...
            int tid = Integer.parseInt(allRequestParams.get("tid"));
            int pid = Integer.parseInt(allRequestParams.get("pid"));
