package cn.tekin.jbpm.demo.config.security;
    ...
    protected void configure(AuthenticationManagerBuilder auth) throws Exception {
        ...
        auth.userDetailsService(customUserService()).passwordEncoder(new PasswordEncoder() {
            ...
            public String encode(CharSequence rawPassword) {
                return ShaUtil.getSHA256((String) rawPassword);//;
            }

            @Override
            public boolean matches(CharSequence rawPassword, String encodedPassword) {
                System.out.println(encodedPassword + "---" + (String) rawPassword);
                return encodedPassword.equals(ShaUtil.getSHA256((String) rawPassword));
            }
        });
    }
